...
Home.fetchAll().then(([registeredHomes]) =>{
    res.render('store/homes', {homes:registeredHomes, pageTitle: 'Home',  isLoggedIn:req.isLoggedIn,});
...
Home.findById(homeId).then(([homes]) => {
    ...
    res.render("store/home-detail", {home:home,pageTitle:"Home Details",  isLoggedIn:req.isLoggedIn});
});
